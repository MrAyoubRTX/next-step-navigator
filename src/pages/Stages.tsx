...
const Stages = () => {
  const { t } = useLanguage();
  const [selectedCity, setSelectedCity] = useState(t("stages.all.cities"));
  const [selectedDomain, setSelectedDomain] = useState(t("stages.all.domains"));
  ...
  const stages = [
    {
      ...
      domain: "Marketing",
      level: "Bac+3/4",
      posted: `${t("stages.posted")} 2 ${t("stages.days")}`,
      logo: "D",
    },
    {
      id: 2,
      ...
      domain: "Informatique",
      level: "Bac+5",
      posted: `${t("stages.posted")} ${t("stages.week")}`,
      logo: "T",
    },
    {
      id: 3,
      ...
      level: "Bac+2/3",
      posted: `${t("stages.posted")} 3 ${t("stages.days")}`,
      logo: "H",
    },
    {
      id: 4,
      ...
      domain: "Finance",
      level: "Bac+4",
      posted: `${t("stages.posted")} 5 ${t("stages.days")}`,
      logo: "F",
    },
  ];
  ...
  const resources = [
    {
      icon: FileText,
      title: t("stages.resources.cv"),
      description: t("stages.resources.cv.desc"),
    },
    {
      icon: FileText,
      title: t("stages.resources.letter"),
      description: t("stages.resources.letter.desc"),
    },
    {
      icon: Video,
      title: t("stages.resources.interview"),
      description: t("stages.resources.interview.desc"),
    },
  ];

  const cities = [t("stages.all.cities"), "Casablanca", "Rabat", "Marrakech", "Tanger", "Fès", "Agadir"];
  const domains = [t("stages.all.domains"), "Marketing", "Informatique", "Finance", "RH", "Commercial", "Design"];

  const filteredStages = stages.filter((stage) => {
    const matchesCity = selectedCity === t("stages.all.cities") || stage.location === selectedCity;
    const matchesDomain = selectedDomain === t("stages.all.domains") || stage.domain === selectedDomain;
          ...
          <div className="container mx-auto px-4 lg:px-8">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
                {t("stages.title")} <span className="text-gradient">{t("stages.title.highlight")}</span>
              </h1>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="lg:col-span-2 space-y-4">
                <div className="flex items-center justify-between mb-6">
                  <p className="text-muted-foreground">
                    <span className="font-semibold text-foreground">{filteredStages.length}</span> {t("stages.offers.found")}
                  </p>
                  <Button variant="ghost" size="sm">
                    <Filter className="w-4 h-4 mr-2" />
                    {t("stages.more.filters")}
                  </Button>
                </div>
              ...
              <div className="space-y-6">
                ...
                <div className="p-6 rounded-2xl bg-card border border-border">
                  <h3 className="text-lg font-semibold text-foreground mb-4">{t("stages.resources")}</h3>
                ...
                <div className="p-6 rounded-2xl bg-accent/5 border border-accent/20">
                  <h3 className="text-lg font-semibold text-foreground mb-3">{t("stages.tip.title")}</h3>
                  <p className="text-sm text-muted-foreground mb-4">
                    {t("stages.tip.content")}
                  </p>
